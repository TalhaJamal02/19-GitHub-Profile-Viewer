      ...
      <Card className="w-full max-w-3xl p-6 space-y-4 shadow-lg rounded-lg bg-white">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-600">
            Search for a GitHub username and view their profile and repositories, search like: <strong>TalhaJamal02</strong>
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit} className="mb-8 px-6">
          <div className="flex items-center gap-4">
            ...
            >
              {loading ? <ClipLoader className="w-4 h-4 text-gray-600" /> : "Search"}
            </Button>
          </div>
        </form>
